...
def hank(x, y, scale):
    ...
    # nose
    pygame.draw.polygon(screen, RED,[(x+30.7960885876309*scale, y+74.2975060714954*scale), (x+30.9014094708176*scale, y+79.8649480303595*scale), (x+29.0023764711405*scale, y+84.7234577485952*scale), (x+25.4149522381599*scale, y+89.0956310325403*scale), (x+17.5674617285149*scale, y+90.1045940980661*scale), (x+11.7378973499214*scale, y+88.5350959961371*scale), (x+8.2625801242214*scale, y+83.9387086976307*scale), (x+6.4688680077311*scale, y+77.7728232971953*scale), (x+6.9172960368537*scale, y+72.3916869477245*scale), (x+10.9531482989569*scale, y+66.2258015472891*scale), (x+17.0069266921117*scale, y+63.5352333725537*scale), (x+24.0696681507922*scale, y+64.4320894307989*scale), (x+29.0023764711405*scale, y+68.467941692902*scale),])
    ...
    # strap
    pygame.draw.polygon(screen, DARKDARKBROWN, [ (x+61*scale, y+55*scale), (x+64*scale, y+66*scale), (x+69*scale, y+71*scale), (x+72*scale, y+80*scale), (x+71*scale, y+89*scale), (x+69*scale, y+96*scale), (x+65*scale, y+102*scale), (x+61*scale, y+106*scale), (x+53*scale, y+110*scale), (x+50*scale, y+110*scale), (x+51*scale, y+112*scale), (x+58*scale, y+113*scale), (x+65*scale, y+111*scale), (x+71*scale, y+108*scale), (x+75*scale, y+105*scale), (x+78*scale, y+100*scale), (x+80*scale, y+94*scale), (x+82*scale, y+89*scale), (x+82*scale, y+83*scale), (x+81*scale, y+78*scale), (x+77*scale, y+68*scale), (x+75*scale, y+66*scale), (x+73*scale, y+55*scale) ])

    # helmet bottom
    pygame.draw.polygon(screen, BUSH2, [(x+19*scale, y+53*scale), (x+55*scale, y+48*scale), (x+74*scale, y+49*scale), (x+92*scale, y+53*scale), (x+93*scale, y+56*scale), (x+92*scale, y+58*scale), (x+90*scale, y+59*scale), (x+89*scale, y+58*scale), (x+73*scale, y+54*scale), (x+50*scale, y+55*scale), (x+47*scale, y+54*scale), (x+45*scale, y+52*scale), (x+38*scale, y+50*scale), (x+31*scale, y+52*scale), (x+28*scale, y+56*scale), (x+25*scale, y+56*scale), (x+22*scale, y+53*scale)])

    # right arm gleam
    pygame.draw.polygon(screen, LIGHTSILVER, [(x+86*scale, y+82*scale), (x+89.5340231231758*scale, y+85.1891057719905*scale), (x+94.0254091521598*scale, y+87.6205327951999*scale), (x+100*scale, y+88*scale), (x+107.1956388612105*scale, y+84.3786300975874*scale), (x+117.6693250284861*scale, y+84.5056419252322*scale), (x+118.2994929394708*scale, y+79.6678436141075*scale), (x+116.7271940332902*scale, y+76.7943318200531*scale), (x+111.4139080744727*scale, y+73.1075619710778*scale), (x+97.2632179188466*scale, y+71.5352630648971*scale), (x+92.871624422273*scale, y+72.7822587491094*scale), (x+88.967985758652*scale, y+75.2762501175339*scale), (x+86.6908632048731*scale, y+78.7461511518636*scale)])

    # left arm gleam
    pygame.draw.polygon(screen, LIGHTSILVER, [(x+6*scale, y+78*scale), (x+7.5800193439241*scale, y+82.9529550830457*scale), (x+7.4974172006182*scale, y+89.0930477354531*scale), (x+7.5266667769288*scale, y+90.2694261372661*scale), (x+5.111368713243*scale, y+89.3604429950187*scale), (x+2.7220415964784*scale, y+87.2308253474677*scale), (x+2.1247098172873*scale, y+84.9194110714673*scale), (x+0.8001915242983*scale, y+84.0623698230626*scale), (x+0.6113602796143*scale, y+82.6075998611618*scale), (x+1.2181418573158*scale, y+81.0906459169081*scale), (x+2.4923831704889*scale, y+79.4826747359992*scale), (x+4*scale, y+78*scale)])

# Add a randomized sun
def draw_sun():  # define the sun
